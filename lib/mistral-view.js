...
export default class MistralView {
  constructor(serializedState) {
    ...
    this.messagesFooter = document.createElement("div");
    const clearChatButton = this.uiHelper.createClearChatButton();
    this.messagesFooter.appendChild(clearChatButton);
    this.element.appendChild(this.messagesFooter);
