  ...
  async sendMessageToMistral(messageContent) {
    ...
    if (userMessage) {
      ...
      const customInstructions = `
        ...
        If input is code with file path and/or selection coordinates (File: path/here;Selection: start, end, start, end) and no other text then output only that code is added to context.
