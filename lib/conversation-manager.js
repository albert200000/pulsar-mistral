  ...
  async sendMessageToMistral(messageContent) {
    ...
    if (userMessage) {
      ...
      const customInstructions = `
        ...
        If input is code with file path and/or selection coordinates (File: path/here\nSelection: start, end, start, end) and no other text then output only that code is added to context.
        If output is code then include file path and/or selection coordinates (File: path/here\nSelection: start, end, start, end) before code output.
      `;
